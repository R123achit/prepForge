...
export default function AIInterviewRoomPage() {
  ...
  const [candidateVideoStream, setCandidateVideoStream] = useState(null);
  ...
  const postureAnalyzerRef = useRef(null);
              ...
              <div className="mb-8 p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-200">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1">
                    {finalFeedback.bodyLanguage.bodyLanguage?.map((item, idx) => (
